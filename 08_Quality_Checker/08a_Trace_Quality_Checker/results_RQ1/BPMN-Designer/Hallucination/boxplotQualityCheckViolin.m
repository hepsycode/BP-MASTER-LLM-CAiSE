...
% Hallucination
subplot(1,4,1,'align');
LLM_hall = [hall_4_LLAMA3; hall_4_GPT35; hall_4_GPT4; hall_4_GOT4o];
g = [zeros(length(hall_4_LLAMA3), 1); ones(length(hall_4_GPT35), 1); 2*ones(length(hall_4_GPT4), 1); 3*ones(length(hall_4_GOT4o), 1)];
% boxplot(LLM_hall, g,'Labels',{'LLama3','GPT-3.5','GPT-4','GPT-4o'},'Whisker',0.5)
MPG = [hall_4_LLAMA3, hall_4_GPT35, hall_4_GPT4, hall_4_GOT4o];
...
% Hallucination
subplot(1,4,2,'align');
LLM_hall = [hall_4_LLAMA3_Sec; hall_4_GPT35_Sec; hall_4_GPT4_Sec; hall_4_GOT4o_Sec];
g = [zeros(length(hall_4_LLAMA3_Sec), 1); ones(length(hall_4_GPT35_Sec), 1); 2*ones(length(hall_4_GPT4_Sec), 1); 3*ones(length(hall_4_GOT4o_Sec), 1)];
% boxplot(LLM_hall, g,'Labels',{'LLama3','GPT-3.5','GPT-4','GPT-4o'},'Whisker',0.5)
MPG = [hall_4_LLAMA3_Sec, hall_4_GPT35_Sec, hall_4_GPT4_Sec, hall_4_GOT4o_Sec];
Origin = {'LLama3','GPT-3.5','GPT-4','GPT-4o'};
Origin = cellstr(Origin);
vs = violinplot(MPG, Origin);
set(gca,'fontsize',12)
...
% Hallucination
subplot(1,4,3,'align');
LLM_hall = [hall_4_LLAMA3_Class; hall_4_GPT35_Class; hall_4_GPT4_Class; hall_4_GOT4o_Class];
g = [zeros(length(hall_4_LLAMA3_Class), 1); ones(length(hall_4_GPT35_Class), 1); 2*ones(length(hall_4_GPT4_Class), 1); 3*ones(length(hall_4_GOT4o_Class), 1)];
% boxplot(LLM_hall, g,'Labels',{'LLama3','GPT-3.5','GPT-4','GPT-4o'},'Whisker',0.5)
MPG = [hall_4_LLAMA3_Class, hall_4_GPT35_Class, hall_4_GPT4_Class, hall_4_GOT4o_Class];
Origin = {'LLama3','GPT-3.5','GPT-4','GPT-4o'};
Origin = cellstr(Origin);
vs = violinplot(MPG, Origin);
set(gca,'fontsize',12)
...
% Hallucination
subplot(1,4,4,'align');
LLM_hall = [hall_4_LLAMA3_Attrs; hall_4_GPT35_Attrs; hall_4_GPT4_Attrs; hall_4_GOT4o_Attrs];
g = [zeros(length(hall_4_LLAMA3_Attrs), 1); ones(length(hall_4_GPT35_Attrs), 1); 2*ones(length(hall_4_GPT4_Attrs), 1); 3*ones(length(hall_4_GOT4o_Attrs), 1)];
% boxplot(LLM_hall, g,'Labels',{'LLama3','GPT-3.5','GPT-4','GPT-4o'},'Whisker',0.5)
MPG = [hall_4_LLAMA3_Attrs, hall_4_GPT35_Attrs, hall_4_GPT4_Attrs, hall_4_GOT4o_Attrs];
Origin = {'LLama3','GPT-3.5','GPT-4','GPT-4o'};
Origin = cellstr(Origin);
vs = violinplot(MPG, Origin);
set(gca,'fontsize',12)
